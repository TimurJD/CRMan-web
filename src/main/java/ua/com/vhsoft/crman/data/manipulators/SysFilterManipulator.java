...
public class SysFilterManipulator {
    ...
    /**
     * Persist filter to database
     *
     * @param sysFilter
     * @return
     */
    public SysFilter persistFilter(SysFilter sysFilter) {
        return sysFilterService.addOrUpdate(sysFilter);
    }
    ...
    public void deleteFilter(Integer id) {
        sysFilterService.deleteById(id);
    }
